 ...
 * @author Mher
 */
public class Lesson04Controller implements Initializable {
    ...
    private final AnchorPane[] contents = new AnchorPane[7];
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        contents[4] = quizReady;
        contents[5] = quizContent;
        contents[6] = quizScore;
        
        me = new Media(getClass().getResource("/main/resources/videos/lesson04-vid.mp4").toExternalForm());
	...
	player.setAutoPlay(false);
        ...
        Parent quiz = null;
        try {
            quiz = FXMLLoader.load(getClass().getResource("/main/resources/view/quiz04.fxml"));
        ...
        if(pageNum < 6){
            ...
            if(pageNum == 6){
                ...
                if(finalScore == 0 ){
                    ...
                    UserSession.setScoreQuiz04(finalScore);
                    quizFinalScore.setText(UserSession.getScoreQuiz04() + " / 5");
                    btnNext.setText("Back to Home"); 
                }
                String username = UserSession.getUserName();
                String queryTotalUsers = "UPDATE `users` SET `quiz4`= '"+ finalScore +"' WHERE `username`='"+ username +"'";
            ...
            UserSession.setProgress(4, pageNum);
